...
Without changing the  selection, switch to the positive rate indicator. On the updated graph, make a note of those countries that <i>also</i> show recent increases, however small but above 2%, in the positive rate. These are Spain, France, Israel, and Belgium; alas, there are no positive rate data available for Costa Rica. 

![Figure 23](/img/img029.png)

By cross-referecing the two results (for consistency, we need both criteria to be met) we get: Spain, France, Israel, and Belgium. 